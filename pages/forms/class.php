...
$class_id = $class_name = $dept_id = $level_id = "";
$class_id_err = $class_name_err = $dept_id_err = $level_id_err = "";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["class_id"]))){
        $class_id_err = "Please enter a Class Code.";
    } else{
        ...
        if($stmt = $mysqli->prepare($sql)){
            ...
            $stmt->bind_param("s", $param_class_id);
            ...
            if($stmt->execute()){
                ...
                if($stmt->num_rows == 1){
                    $class_id_err = "This Class Code is already taken.";
                } else{
     ...
     if(empty(trim($_POST["class_name"]))){
        $class_name_err = "Please Select Class Name.";     
    } else{
    ...
    if(empty(trim($_POST["level_id"]))){
        $level_id_err = "Please Select Level Code .";     
    } else{
    ...
    if(empty($class_id_err) && empty($class_name_err) && empty($dept_id_err)){
        
        // Prepare an insert statement
        $sql = "INSERT INTO class (class_id,class_name,dept_id,level_id) VALUES (?,?,?,?)";
         
        if($stmt = $mysqli->prepare($sql)){
            // Bind variables to the prepared statement as parameters
            $stmt->bind_param("ssss", $param_class_id, $param_class_name,  $param_dept_id, $param_level_id);
      ...
      <div class="row">
        ...
        <div class="box">
            <div class="box-header">
              <h3 class="box-title">Class Features </h3>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php
                      ...
                      try{  
                          $sql = 'SELECT class.class_id, class.class_name,class.dept_id,class.level_id FROM class';

                         $query = $db->prepare($sql);

                         $query->execute(array('class_id'=>$class_id));

                         $cls = $query->fetchAll(PDO::FETCH_OBJ);
                         ...
                         if ($query->rowCount() > 0) {
                          ...
                          foreach ($cls as $row) 
                          {
                            ...
                            <tr>
                              ...
                              <td>
                                <a href="#class_edit_<?php echo $row->class_id; ?>" class="btn btn-success btn-sm" data-toggle="modal"><span class="fa fa-edit "></span> Edit </a>
                                <a href="#class_delete_<?php echo $row->class_id; ?>" class="btn btn-danger btn-sm" data-toggle="modal"><span class="fa fa-trash"></span> Delete </a>
                              </td>
                             <?php include 'class_edit_delete_modal.php';?>
                            </tr>
                            <?php 
                            $i++;
                          }
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9 <?php echo (!empty($class_id_err)) ? 'has-error' : ''; ?>">
                    <input type="text" name="class_id" class="form-control"  placeholder="Class Code">
                ...
                <div class="form-group ">
                  ...
                  <div class="col-sm-9 <?php echo (!empty($class_name_err)) ? 'has-error' : ''; ?>">
                ...
                <div class="form-group">
                  <label for="inputdept_id3" class="col-sm-3 control-label"> Department </label>
                ...
                <div class="form-group">
                  <label for="inputdept_id3" class="col-sm-3 control-label">Level </label>
